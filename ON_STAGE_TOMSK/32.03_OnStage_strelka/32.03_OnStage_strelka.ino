...
#define PIN 8 //matrix connection pin 
#define mw 8 // ширина
#define mh 8 // высота
...
void loop() {
  ...
  */
  ...
  matrix->drawRGBBitmap(0, 0, (const uint16_t *)ODIN, 8, 8);
  matrix->show();
  delay(700);
  matrix->drawRGBBitmap(0, 0, (const uint16_t *)DWA, 8, 8);
  matrix->show();
  delay(700);
  matrix->drawRGBBitmap(0, 0, (const uint16_t *)TRI, 8, 8);
  matrix->show();
  delay(700);
  matrix->drawRGBBitmap(0, 0, (const uint16_t *)CHETIRE, 8, 8);
  matrix->show();
  delay(700);
  matrix->drawRGBBitmap(0, 0, (const uint16_t *)PYAT, 8, 8);
  matrix->show();
  delay(700);
  matrix->drawRGBBitmap(0, 0, (const uint16_t *)SHEST, 8, 8);
  matrix->show();
  delay(700);
  matrix->drawRGBBitmap(0, 0, (const uint16_t *)SEM, 8, 8);
  matrix->show();
  delay(700);
  matrix->drawRGBBitmap(0, 0, (const uint16_t *)VOSEM, 8, 8);
  matrix->show();
  delay(700);//*/
  matrix->fillRect(bmx, bmy, bmx + 8, bmy + 8, LED_BLACK); //очистка матрицы
